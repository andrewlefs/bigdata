...
STOCK_A_B_C_D_G = JOIN STOCK_A_B_C_D BY third_uname, STOCK_G1 BY mobo_service_id;


--INFOMATION NEED
STOCK_FINAL = FOREACH STOCK_A_B_C_D_G GENERATE $4 as date,$4 as date_modify,$gameid as game_id,$serverid as server_id,CONCAT((chararray)$gameid,CONCAT('_',CONCAT((chararray)$serverid,CONCAT('_',(chararray)$0)))) as game_guild_id,CONCAT((chararray)$gameid,CONCAT('_',CONCAT((chararray)$serverid,CONCAT('_',(chararray)$1)))) as game_guild_name,$2 as game_guild_create_date,$5 as game_guild_leader_name,$15 as msi_leader,$17 as mobo_id,$19 as fullname,$15 as accid_leader ,(chararray)$3 as role_id_leader;
