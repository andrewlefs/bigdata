...
--INFOMATION NEED
STOCK_FINAL = FOREACH STOCK_B_C_D_G GENERATE CONCAT((chararray)'$ALIAS',CONCAT('_',CONCAT((chararray)$serverid,CONCAT('_',(chararray)$1)))) as game_guild_id,$4 as date,$2 as join_date,$11 as msi_mem,$11 as accid_mem,$13 as mobo_id,(chararray)$15 as fullname,(chararray)$3 as role_id_mem,0 as statussend;
