...
public class ParseprotoQHVGuildMember extends EvalFunc<Map<String, Object>>{
    ...
    static JSONArray printGuildMember(PlayerHasGangInfoMessage gangaction){
		/*
    ...
    public Map<String, Object> exec(Tuple input) throws IOException {
        ...
        try {
    		...
    		JSONArray jsonmap = printGuildMember(gangaction);
    		JSONObject testparams = new JSONObject();
    		testparams.put("value", jsonmap);
            Map<String, Object> values = jsonMapper.readValue((String)testparams.toString(),
