...
$arrayip = array("115.78.161.88","115.78.161.124","118.69.76.212","14.161.5.226");
?>
        <div class="shadow">
        ...
        <div class="content">
            ...
            <?php
                foreach($listappitem as $val){
					...
					if( ($checkstatus && in_array($_SERVER['REMOTE_ADDR'],$arrayip))=== true  || $val['isactive']== 1) {
            ?>
                                    ...
                                    <?php
										...
										if(empty($parselist[$val['note']])){
										  if($val['type_event']=='like'){
											...
											$val['share_link'],
											"http://m-app.mobo.vn".$val['share_picture'],
											$val['share_title'],
											$val['share_caption'],
											$val['share_title'],
											$val['share_description'],
											$val['note']) ;
										 }elseif($val['type_event']=='invite'){
