 ...
 */
class MeAPI_Model extends CI_Model {
    ...
    function __construct() {
        parent::__construct();
        $this->db_master = $this->load->database(array('db' => 'dbmobo', 'type' => 'master'), TRUE);
        $this->db_slave = $this->load->database(array('db' => 'dbmobo', 'type' => 'slave'), TRUE);
    }
