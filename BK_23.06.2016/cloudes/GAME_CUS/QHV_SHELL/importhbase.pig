...
--$0 as key,
STOCK_FINAL = FOREACH STOCK_F_DONE GENERATE $3 as accid_mem,$8 as date,$8 as date_modify,
...
STORE STOCK_FINAL INTO 'bigdata.bigdata_qhv_temp' USING org.apache.hive.hcatalog.pig.HCatStorer();
/*
