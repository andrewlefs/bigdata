...
--(chararray)$2#'member_role_id' as key,
STOCK_FINAL = FOREACH STOCK_A_D_B GENERATE $8 as accid_mem,$3 as date,$3 as date_modify,
...
/*
STORE STOCK_FINAL INTO 'hbase://bigdata_th_temp' USING org.apache.pig.backend.hadoop.hbase.HBaseStorage('info:accid_mem,info:date,info:date_modify,info:game_guild_create_date,info:game_guild_id,info:game_guild_name,info:game_id,info:leadername,info:join_date,info:msi_mem,info:role_id_mem,info:role_name,info:server_id');
*/

STORE STOCK_FINAL INTO 'bigdata.bigdata_th_temp' USING org.apache.hive.hcatalog.pig.HCatStorer();
/*
—Load from HBase
