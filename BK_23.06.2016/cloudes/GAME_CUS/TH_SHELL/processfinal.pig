--STOCK_F = LOAD 'hbase://bigdata_th_temp' using org.apache.pig.backend.hadoop.hbase.HBaseStorage('info', '-loadKey true');
STOCK_F = LOAD 'bigdata.bigdata_th_temp' using org.apache.hive.hcatalog.pig.HCatLoader();       
